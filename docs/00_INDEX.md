...
| 04 | `04_EVALS.md` | Five acceptance evaluations with worked solutions | stable; all five plus the stretch tasks (1s, 3s, 3p, 3g) and eval 6 (cubic Galileon, first verified Horndeski member) implemented and kernel-verified |
